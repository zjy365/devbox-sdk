        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-2 space-y-6">
            ...
            <p className="text-[#666] max-w-sm text-sm leading-relaxed">
              Enterprise TypeScript SDK for Sealos Devbox. Building the future of programmatic cloud
              environments.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-[#666]">
              ...
              <li>
                <a href="https://sealos.io" className="hover:text-black transition-colors">
                  Sealos
                </a>
              </li>
            </ul>
